  ...
  <html>
    ...
    <body>
      ...
      <footer class="site-footer">
        <p>Poll It! — a simple site by <a target="_blank" href="https://www.rdrobny.me">Ryan Drobny</a></p>
        <p><a href="/">Home</a></p>
      </footer>
    </body>
  </html>`;
...
<body>
  <div class="card">
    ...
    <p></p>
    <p><a target="_blank" href="http://pollit.dev/p/wPvOYa-qO5">Take a Poll!</a> - provide feedback on Poll It!</p>
    <hr />
  </div>
</body>
</html>`));
